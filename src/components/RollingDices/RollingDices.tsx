...
export function RollingDices() {
    ...
    const { roundActive, setRoundActive, score } = useGameplayContext();
        ...
        <>
            <div style={{display: 'flex', flexDirection: 'row'}}>
                <div style={{display: 'flex', flexDirection: 'column', alignItems: 'center'}}>
                    <h1 style={{fontWeight: 'bold'}}> Vos dés </h1>
                    ...
                    <button className="button" onClick={handleRoll} disabled={isRollDisabled}>
                        Roll
                    </button>
                </div>
                <div>
                    {/* <p> Mon nom : {playerName}</p>
                        TODO: à ajouter dans la navbar */}
                    <p> Mon score : {score}</p>
                </div>
            </div>
        </>
